			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="tg-innerbannercontent hidden-lg hidden-md hidden-sm">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tuition-centres.html#"><img src="/images/thumbnails/img-21.jpg" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tuition-centres.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tuition-centres.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnadd" href="dashboard-tuition-centres.html#"><i>+</i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tuition-centres.html#">2212 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tuitiondashboard">
						<div class="col-sm-3 col-xs-12 pull-left">
							...
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tuition-centres.html#">
									<i class="fa fa-tv"></i>
						...
						<div class="col-sm-9 col-xs-12 pull-right">
							...
							<div class="tg-alertmessages">
								<div class="alert alert-success tg-alertmessage fade in">
									<a href="dashboard-tuition-centres.html#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							...
							<div class="tg-contentbox">
								<div class="row">
									<div class="col-sm-8 col-xs-12">
										...
										<a class="tg-btn tg-btn-lg" href="dashboard-tuition-centres.html#">view all</a>
									</div>
										...
										<ul class="tg-comment">
											<li>
												<div class="tg-commenter">
													<a class="tg-btntogglecontent" href="dashboard-tuition-centres.html#"><i class="fa fa-angle-down"></i></a>
													...
													<div class="tg-commenterinfo">
														<div class="tg-authorhead">
															<div class="tg-authorname">
																<h3><a href="dashboard-tuition-centres.html#">Dante Edberg</a></h3>
																<time datetime="2016-12-20 08:00">2 days ago</time>
															</div>
															<span class="tg-stars"><span></span></span>
														</div>
