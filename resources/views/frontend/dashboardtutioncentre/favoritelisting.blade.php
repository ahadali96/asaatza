						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tuition-favorites-listing.html#"><img src="/images/thumbnails/img-21.jpg" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tuition-favorites-listing.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tuition-favorites-listing.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnadd" href="dashboard-tuition-favorites-listing.html#"><i>+</i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tuition-favorites-listing.html#">2212 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tuitiondashboard">
						<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
							...
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tuition-favorites-listing.html#">
									<i class="fa fa-tv"></i>
						...
						<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
							...
							<nav class="tg-pagination">
								<ul>
									<li class="tg-prevpage"><a href="dashboard-tuition-favorites-listing.html#"><i class="fa fa-angle-left"></i></a></li>
									<li><a href="dashboard-tuition-favorites-listing.html#">1</a></li>
									<li><a href="dashboard-tuition-favorites-listing.html#">2</a></li>
									<li><a href="dashboard-tuition-favorites-listing.html#">3</a></li>
									<li class="tg-active"><a href="dashboard-tuition-favorites-listing.html#">4</a></li>
									<li><a href="dashboard-tuition-favorites-listing.html#">5</a></li>
									<li>...</li>
									<li><a href="dashboard-tuition-favorites-listing.html#">10</a></li>
									<li class="tg-nextpage"><a href="dashboard-tuition-favorites-listing.html#"><i class="fa fa-angle-right"></i></a></li>
								</ul>
							</nav>
						</div>
					</div>
