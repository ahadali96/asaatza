					...
					<div class="col-sm-12 col-xs-12">
						<div class="tg-innerbannercontent">
							...
							<ol class="tg-breadcrumb">
								<li><a href="tuition-center.html#">Home</a></li>
								...
								<div class="tg-tuitioncenters tg-tuitioncentersgrid">
									...
									<div class="tg-activefilters">
										...
										<div class="tg-filters">
											<a class="tg-btnfilter" href="tuition-center.html#">
											...
											<a class="tg-btnclearall" href="tuition-center.html#">Clear All</a>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6 tg-fullwidth">
											<div class="tg-tuitioncenter">
												<figure class="tg-tuitioncenterdp">
													<a href="tuition-center.html#"><img src="images/tuitioncenter/img-01.jpg" alt="image description"></a>
													<figcaption>
														<a class="tg-usericon tg-iconfeatured" href="tuition-center.html#">
															<em class="tg-usericonholder">
																<i class="fa fa-bolt"></i>
																<span>featured</span>
															</em>
														</a>
														<a class="tg-usericon tg-iconvarified" href="tuition-center.html#">
															<em class="tg-usericonholder">
												...
												<div class="tg-tuitioncenterinfo">
													<div class="tg-jobhead">
														<h3><a href="tuition-center.html#">Manchester Sun Light</a></h3>
														<span class="tg-tutioncategory"><a href="tuition-center.html#">Arts &amp; Design Academy</a></span>
														<ul class="tg-jobsmetadata">
															<li><span class="tg-stars"><span></span></span></li>
															<li><a href="tuition-center.html#"><i class="fa fa-heart tg-like"></i></a></li>
															<li><a href="tuition-center.html#">1509 view</a></li>
														</ul>
													</div>
													...
													<div class="tg-jobfoot">
														<ul class="tg-tags">
															<li><a class="tg-tag" href="tuition-center.html#">Academic</a></li>
															<li><a class="tg-tag" href="tuition-center.html#">Life Style</a></li>
															<li><a class="tg-tag" href="tuition-center.html#">Languages</a></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6 tg-fullwidth">
											<div class="tg-tuitioncenter">
												<figure class="tg-tuitioncenterdp">
													<a href="tuition-center.html#"><img src="images/tuitioncenter/img-02.jpg" alt="image description"></a>
													<figcaption>
														<a class="tg-usericon tg-iconfeatured" href="tuition-center.html#">
															<em class="tg-usericonholder">
																<i class="fa fa-bolt"></i>
												...
												<div class="tg-tuitioncenterinfo">
													<div class="tg-jobhead">
														<h3><a href="tuition-center.html#">Success Road Academy</a></h3>
														<span class="tg-tutioncategory"><a href="tuition-center.html#">Commerce Group College</a></span>
														<ul class="tg-jobsmetadata">
															<li><span class="tg-stars"><span></span></span></li>
															<li><a href="tuition-center.html#"><i class="fa fa-heart tg-like"></i></a></li>
															<li><a href="tuition-center.html#">1509 view</a></li>
										...
										<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6 tg-fullwidth">
											<div class="tg-tuitioncenter">
												<figure class="tg-tuitioncenterdp">
													<a href="tuition-center.html#"><img src="images/tuitioncenter/img-03.jpg" alt="image description"></a>
													<figcaption>
														<a class="tg-usericon tg-iconfeatured" href="tuition-center.html#">
															<em class="tg-usericonholder">
																<i class="fa fa-bolt"></i>
												...
												<div class="tg-tuitioncenterinfo">
													<div class="tg-jobhead">
														<h3><a href="tuition-center.html#">State College Of Sydney</a></h3>
														<span class="tg-tutioncategory"><a href="tuition-center.html#">Commerce Group College</a></span>
														<ul class="tg-jobsmetadata">
															<li><span class="tg-stars"><span></span></span></li>
															<li><a href="tuition-center.html#"><i class="fa fa-heart tg-like"></i></a></li>
										...
										<div class="col-lg-4 col-md-6 col-sm-12 col-xs-6 tg-fullwidth">
											<div class="tg-tuitioncenter">
												<figure class="tg-tuitioncenterdp">
													<a href="tuition-center.html#"><img src="images/tuitioncenter/img-04.jpg" alt="image description"></a>
													<figcaption>
														<a class="tg-usericon tg-iconfeatured" href="tuition-center.html#">
															<em class="tg-usericonholder">
																<i class="fa fa-bolt"></i>
												...
												<div class="tg-tuitioncenterinfo">
													<div class="tg-jobhead">
														<h3><a href="tuition-center.html#">Manchester University</a></h3>
														<span class="tg-tutioncategory"><a href="tuition-center.html#">Arts Campus For Girls</a></span>
														<ul class="tg-jobsmetadata">
															<li><span class="tg-stars"><span></span></span></li>
															<li><a href="tuition-center.html#"><i class="fa fa-heart tg-like"></i></a></li>
															<li><a href="tuition-center.html#">1509 view</a></li>
									...
									<nav class="tg-pagination">
										<ul>
											<li class="tg-prevpage"><a href="tuition-center.html#"><i class="fa fa-angle-left"></i></a></li>
											<li><a href="tuition-center.html#">1</a></li>
											<li><a href="tuition-center.html#">2</a></li>
											<li><a href="tuition-center.html#">3</a></li>
											<li class="tg-active"><a href="tuition-center.html#">4</a></li>
											<li><a href="tuition-center.html#">5</a></li>
											<li>...</li>
											<li><a href="tuition-center.html#">10</a></li>
											<li class="tg-nextpage"><a href="tuition-center.html#"><i class="fa fa-angle-right"></i></a></li>
										</ul>
									</nav>
								</div>
							</div>
