						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tuition-security-setting.html#"><img src="/images/thumbnails/img-21.jpg" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tuition-security-setting.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tuition-security-setting.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnadd" href="dashboard-tuition-security-setting.html#"><i>+</i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tuition-security-setting.html#">2212 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tuitiondashboard">
						<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
							...
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tuition-security-setting.html#">
									<i class="fa fa-tv"></i>
							...
							<form class="tg-formtheme">
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												<input type="password" name="age" class="form-control" placeholder="Current Password *">
											</div>
										</div>
										<div class="col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												<input type="password" name="age" class="form-control" placeholder="New Password *">
											</div>
										</div>
										<div class="col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												<input type="password" name="age" class="form-control" placeholder="Retype Password *">
											</div>
										</div>
										<div class="col-sm-12 col-xs-12">
											<div class="form-group">
								...
								<fieldset>
									<div class="row">
										...
										<div class="col-sm-12 col-xs-12">
											<div class="form-group">
												<textarea class="form-control" placeholder="Why Leaving Us?"></textarea>
											</div>
										</div>
										<div class="col-sm-12 col-xs-12">
											<button class="tg-btn" type="submit">Deactivate now</button>
										</div>
									</div>
								</fieldset>
							</form>
