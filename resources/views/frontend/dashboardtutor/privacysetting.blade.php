						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tutor-privacy-settings.html#"><img src="/images/thumbnails/img-21.jpg" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tutor-privacy-settings.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tutor-privacy-settings.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnadd" href="dashboard-tutor-privacy-settings.html#"><i>+</i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tutor-privacy-settings.html#">2212 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tuitiondashboard">
						...
						@include ('frontend.dashboardtutor.dashboardwidget')
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tutor-privacy-settings.html#">
									<i class="fa fa-tv"></i>
