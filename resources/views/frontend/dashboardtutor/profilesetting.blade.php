						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tutor-profile-settings.html#"><img src="/images/tutors/img-01.jpg" height="120" width="120" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tutor-profile-settings.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tutor-profile-settings.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnedit" href="dashboard-tutor-profile-settings.html#"><i class="fa fa-pencil"></i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tutor-profile-settings.html#">1509 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tutordashboard">
						...
						@include('frontend.dashboardtutor.dashboardwidget')
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tutor-profile-settings.html#">
									<i class="fa fa-tv"></i>
						...
						<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
							...
							<form class="tg-formtheme">
								...
								<fieldset>
									<div class="row">
										<div class="col-sm-12 col-xs-12">
											...
											<ul class="tg-videos">
												<li>
													<figure><a href="dashboard-tutor-profile-settings.html#"><img src="/images/videos/img-01.jpg" alt="image description"></a></figure>
													<div class="tg-description">
														<a href="dashboard-tutor-profile-settings.html#"><i class="fa fa-pencil"></i></a>
														<span class="tg-videolink"><a href="dashboard-tutor-profile-settings.html#">www.youtube.com/tutortutortutortutortutortutortutortutor</a></span>
														<a class="tg-btndelete" href="dashboard-tutor-profile-settings.html#"><i class="fa fa-close"></i></a>
													</div>
												</li>
												<li>
													<figure><a href="dashboard-tutor-profile-settings.html#"><img src="/images/videos/img-02.jpg" alt="image description"></a></figure>
													<div class="tg-description">
														<a href="dashboard-tutor-profile-settings.html#"><i class="fa fa-pencil"></i></a>
														<span class="tg-videolink"><a href="dashboard-tutor-profile-settings.html#">www.youtube.com/tutortutortutortutortutortutortutortutor</a></span>
														<a class="tg-btndelete" href="dashboard-tutor-profile-settings.html#"><i class="fa fa-close"></i></a>
												...
												<li>
													<figure><a href="dashboard-tutor-profile-settings.html#"><img src="/images/videos/img-03.jpg" alt="image description"></a></figure>
													<div class="tg-description">
														<a href="dashboard-tutor-profile-settings.html#"><i class="fa fa-pencil"></i></a>
														<span class="tg-videolink"><a href="dashboard-tutor-profile-settings.html#">www.youtube.com/tutortutortutortutortutortutortutortutor</a></span>
														<a class="tg-btndelete" href="dashboard-tutor-profile-settings.html#"><i class="fa fa-close"></i></a>
								...
								<fieldset>
									<a class="tg-btn" href="dashboard-tutor-profile-settings.html#">Update All Changes</a>
