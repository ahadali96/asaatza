						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tutor-upgradepackage.html#"><img src="/images/thumbnails/img-21.jpg" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tutor-upgradepackage.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tutor-upgradepackage.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnadd" href="dashboard-tutor-upgradepackage.html#"><i>+</i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tutor-upgradepackage.html#">2212 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tuitiondashboard">
						<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
							...
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tutor-upgradepackage.html#">
									<i class="fa fa-tv"></i>
								...
								<fieldset>
									<div class="tg-pkgexpireyandcounter">
										<div class="tg-dashboardnotification tg-pkgexpirey">
											...
											<a class="tg-btn" href="dashboard-tutor-upgradepackage.html#">renew now</a>
										</div>
									...
									<div class="tg-packagesplanstabs">
										<ul class="tg-navpackageplans" role="tablist">
											<li role="presentation" class="active">
												<a href="dashboard-tutor-upgradepackage.html#tg-basic" aria-controls="tg-basic" role="tab" data-toggle="tab">
											...
											<li role="presentation">
												<a href="dashboard-tutor-upgradepackage.html#tg-silver" aria-controls="tg-silver" role="tab" data-toggle="tab">
													<div class="tg-pkgplan">
														<div class="tg-pkgplanhead">
															<h3>Sliver</h3>
											...
											<li role="presentation">
												<a href="dashboard-tutor-upgradepackage.html#tg-gold" aria-controls="tg-gold" role="tab" data-toggle="tab">
													<div class="tg-pkgplan">
														<div class="tg-pkgplanhead">
															<h3>gold</h3>
										...
										<div class="tab-content tg-pkgtabcontent">
											<div role="tabpanel" class="tab-pane fade in active" id="tg-basic">
												...
												<div class="tg-pkgfoot">
													<a class="tg-btn" href="dashboard-tutor-upgradepackage.html#">proceed Now</a>
