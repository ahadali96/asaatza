					...
					<div class="col-sm-12 col-xs-12">
						<div class="tg-innerbannercontent">
							...
							<ol class="tg-breadcrumb">
								<li><a href="tutors.html#">Home</a></li>
								...
								<div class="tg-tutors tg-tutorsgrid">
									...
									<div class="tg-activefilters">
										...
										<div class="tg-filters">
											<a class="tg-btnfilter" href="tutors.html#">
											...
											<a class="tg-btnclearall" href="tutors.html#">Clear All</a>
										</div>
									</div>
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-01.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
														<span>featured</span>
													</em>
												</a>
												<a class="tg-usericon tg-iconvarified" href="tutors.html#">
													<em class="tg-usericonholder">
										...
										<div class="tg-tutorinfo">
											<div class="tg-jobhead">
												...
												<h3><a href="tutors.html#">Lawrence Troutman</a></h3>
												<div class="tg-subjects">Mathematics &amp; Statistics</div>
												<ul class="tg-jobsmetadata">
													<li><span class="tg-stars"><span></span></span></li>
													<li><a href="tutors.html#"><i class="fa fa-heart tg-like"></i></a></li>
													<li><a href="tutors.html#">1509 view</a></li>
												</ul>
											</div>
											...
											<div class="tg-jobfoot">
												<ul class="tg-tags">
													<li><a class="tg-tag" href="tutors.html#">Accounting</a></li>
													<li><a class="tg-tag" href="tutors.html#">Finance</a></li>
													<li><a class="tg-tag" href="tutors.html#">Law</a></li>
												</ul>
											</div>
										</div>
									</div>
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-02.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
										...
										<div class="tg-tutorinfo">
											<div class="tg-jobhead">
												...
												<h3><a href="tutors.html#">Ahmad Carstensen</a></h3>
												<div class="tg-subjects">Mathematics &amp; Statistics</div>
												<ul class="tg-jobsmetadata">
													<li><span class="tg-stars"><span></span></span></li>
													<li><a href="tutors.html#"><i class="fa fa-heart tg-like"></i></a></li>
									...
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-03.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
									...
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-04.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
									...
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-05.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
									...
									<div class="tg-tutor">
										<figure class="tg-tutordp">
											<a href="tutors.html#"><img src="images/tutors/img-06.jpg" height="120" width="120" alt="image description"></a>
											<figcaption>
												<a class="tg-usericon tg-iconfeatured" href="tutors.html#">
													<em class="tg-usericonholder">
														<i class="fa fa-bolt"></i>
									...
									<nav class="tg-pagination">
										<ul>
											<li class="tg-prevpage"><a href="tutors.html#"><i class="fa fa-angle-left"></i></a></li>
											<li><a href="tutors.html#">1</a></li>
											<li><a href="tutors.html#">2</a></li>
											<li><a href="tutors.html#">3</a></li>
											<li class="tg-active"><a href="tutors.html#">4</a></li>
											<li><a href="tutors.html#">5</a></li>
											<li>...</li>
											<li><a href="tutors.html#">10</a></li>
											<li class="tg-nextpage"><a href="tutors.html#"><i class="fa fa-angle-right"></i></a></li>
										</ul>
									</nav>
								</div>
							</div>
