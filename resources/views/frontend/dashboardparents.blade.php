						...
						<div class="tg-innerbannercontent">
							<div class="tg-pagehead">
								<figure class="tg-tutordp">
									<a href="dashboard-tutor.html#"><img src="images/tutors/img-01.jpg" height="120" width="120" alt="image description"></a>
									<figcaption>
										<a class="tg-usericon tg-iconfeatured" href="dashboard-tutor.html#">
											<em class="tg-usericonholder">
												<i class="fa fa-bolt"></i>
												<span>featured</span>
											</em>
										</a>
										<a class="tg-usericon tg-iconvarified" href="dashboard-tutor.html#">
											<em class="tg-usericonholder">
								...
								<div class="tg-tutorinfo">
									<a class="tg-btnedit" href="dashboard-tutor.html#"><i class="fa fa-pencil"></i></a>
									<div class="tg-jobhead">
										...
										<ul class="tg-jobsmetadata">
											...
											<li><a href="dashboard-tutor.html#">1509 view</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div id="tg-content" class="tg-content tg-dashboard tg-tutordashboard">
						<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
							...
							<div class="tg-widgetdashboard">
								<a class="tg-customerviewpage" href="dashboard-tutor.html#">
									<i class="fa fa-tv"></i>
						...
						<div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
							...
							<div class="tg-alertmessages">
								<div class="alert alert-success tg-alertmessage fade in">
									<a href="dashboard-tutor.html#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							...
							<div class="tg-contentbox">
								<div class="row">
									<div class="col-md-8 col-sm-12 col-xs-12">
										...
										<a class="tg-btn tg-btn-lg" href="dashboard-tutor.html#">view all</a>
									</div>
										...
										<ul class="tg-comment">
											<li>
												<div class="tg-commenter">
													<a class="tg-btntogglecontent" href="dashboard-tutor.html#"><i class="fa fa-angle-down"></i></a>
													...
													<div class="tg-commenterinfo">
														<div class="tg-authorhead">
															<div class="tg-authorname">
																<h3><a href="dashboard-tutor.html#">Dante Edberg</a></h3>
